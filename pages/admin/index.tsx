...
Admin.getInitialProps = async (ctx: NextPageContext) => {
  ...
  const res = await service.coupang.getCoupangItems(cookie, ctx.req ? `https://${ctx.req.headers.host}` : "");
...
const CodeInput = styled(InputBox)`
`
const NameInput = styled(InputBox)`
`;
const UrlInput = styled(InputBox)`
`;
